<!--
**Jeongwan2/Jeongwan2** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- 구글맵 크롤링, GUI 구현, 키워드 기반 추천
- 👉 [프로젝트 GitHub 링크](https://github.com/erica414/OpenSource)
- 사용자별 취향과 조건에 맞는 국밥집 추천을 위해, 부산 지역 국밥집 리뷰 데이터를 수집하고 정제하여 키워드 기반 추천 기능을 제공하는 프로젝트입니다.
### 맡은 역할
- 프로젝트 리더(방향성 설정 및 문제 해결 가이드 제공)
